# -*- coding: utf-8 -*-
"""
Created on Wed Jan 02 13:09:39 2013
...
import models.direct.direct_stimulate_ac_current_m01_v01 as ns_model
...
for range_name in range_names:
    ...
    for k in range(len(finterval)-1):
        ...
        model.c_p_dut.u = 2 * 0.289 * 0.5 * model.c_p_dut.v
        model.r_p_dut.v = 10
        model.r_p_dut.u = 2 * 0.289 * 0.5 * model.r_p_dut.v 
        model.c_leads.v = 50e-12
        model.c_leads.u = 0.289 * 2 * 0.1 * model.c_leads.v       
